...
Page({
    ...
    toScreen: function(t){
        ...
        this.setData({
            ...
            distance:this.data.runner[index].distance,
            start_line:this.data.runner[index].start_line,
            finish_line:this.data.runner[index].finish_line,
